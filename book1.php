    ...
    <main>
        ...
        <section >
            <table >
                <tr>
                    <td>
                        <figure ><img src="b1.jpg" alt="The man burned by winter, By Pete Zacharias" width="250">
                            <figcaption align="center">
                                The man burned by winter<br>Pete Zacharias<br>$4.99
                                <br>  
                    ...
                    <td valign="top">
                        ...
                        <?php
                            ...
                            while($row= mysqli_fetch_assoc($result)){
                                if ($row["name"]=="The man burned by winter"){
